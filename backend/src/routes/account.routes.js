...
import { createAccount, getMyAccounts, getAccountById } from "../controllers/account.controller.js";
...
// GET /api/accounts/:id — get a single account (ownership enforced in controller)
